...
This page gathers the software I work on, from language-specific packages to
larger tools and experiments.
...
[cronista](https://github.com/b-rodrigues/cronista/) is a Python port of my R package `{chronicler}`.

## Other software

### T

[T](https://github.com/b-rodrigues/tlang) is an experimental,
reproducibility-first language and orchestration engine for polyglot data
science. It is built around immutable, composable pipelines and uses Nix to
make environments, builds and execution reproducible across machines.

### Korppi

[Korppi](https://github.com/b-rodrigues/korppi/) is an offline-first text editor
for asynchronous collaboration. It stores documents as a series of patches so
changes from different collaborators can be imported, reviewed, accepted or
rejected, making it a Git-free alternative for people used to track changes in
word processors.
