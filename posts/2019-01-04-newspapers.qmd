...
<img src="../assets/img/Wales.jpg" title = "Sometimes ads are better than this. Especially if it's Flex Tape ® ads."></a></p>
</div>
...
<p><img src="../assets/img/pray%20for%20senators.png" /><!-- --></p>
...
<p><img src="../assets/img/tallest_soldier.jpg" /><!-- --></p>
...
<p><img src="../assets/img/layout.png" /><!-- --></p>
...
result %&gt;%
    ...
    coord_flip() +
    theme_blog()</code></pre>
<p><img src="../assets/img/newspapers-13-1.png" width="672" /></p>
