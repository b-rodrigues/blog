...
<img src="../assets/img/deepfried_loss.png" title = "Click here to listen to epic music while reading" width="80%" height="auto"></a></p>
</div>
...
<a href="2018-11-01-nethack.qmd">post</a>.
...
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-12-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-14-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<pre class="r"><code>ascensions_per_day %&gt;%
  ...
  scale_fill_blog() + 
  theme(legend.title = element_blank())</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-15-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<pre class="r"><code>nethack %&gt;%
  ...
  theme_blog()</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-20-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<pre class="r"><code>nethack %&gt;%
  ...
  theme_blog()</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-22-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-25-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<pre><code>## Selecting by n</code></pre>
<pre><code>## [[1]]</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-26-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre><code>## 
## [[2]]</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-26-2.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre><code>## 
## [[3]]</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-26-3.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre><code>## 
## [[4]]</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-26-4.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre><code>## 
## [[5]]</code></pre>
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-26-5.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre><code>## 
## [[6]]</code></pre>
<img src="../assets/img/nethack_analysis-26-6.png" width="80%" height="auto" / width="80%" height="auto">
</details>
...
<div style="text-align: center;"><img src="../assets/img/nethack_analysis-33-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
