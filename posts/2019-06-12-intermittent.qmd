...
<img src="../assets/img/diehard.jpg" title = "Die Hard is the best Christmas movie" width="600" height="400"></a></p>
</div>
...
ggplot(rdieharder) +
  ...
  theme_blog()</code></pre>
<p><img src="../assets/img/intermittent-3-1.png" width="672" /></p>
...
ggplot(january_2018) +
  geom_line(aes(y = count, x = date), colour = &quot;#82518c&quot;) +
  theme_blog()</code></pre>
<p><img src="../assets/img/intermittent-5-1.png" width="672" /></p>
...
<pre class="r"><code>ggplot(test_data_longer) +
  ...
  theme_blog()</code></pre>
<p><img src="../assets/img/intermittent-13-1.png" width="672" /></p>
