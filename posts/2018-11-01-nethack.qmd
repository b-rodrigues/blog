...
<p><img src="../assets/img/dumplogs.png" /><!-- --></p>
...
<p><img src="../assets/img/selectorgadget1.png" /><!-- --></p>
<p>and then the links I am interested in:</p>
<p><img src="../assets/img/selectorgadget2.png" /><!-- --></p>
...
in RStudio:</p>
<p><img src="../assets/img/r_package1.png" /><!-- --></p>
<p>Then select “R package”:</p>
<p><img src="../assets/img/r_package2.png" /><!-- --></p>
<p>Then name your package, create a git repository and then click on “Create Project”:</p>
<p><img src="../assets/img/r_package3.png" /><!-- --></p>
...
<p><img src="../assets/img/r_package_check.png" /><!-- --></p>
