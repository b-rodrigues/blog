...
<img src="../assets/img/kermit.png" title = "It is always so tempting"></a></p>
</div>
...
<p><img src="../assets/img/mice_exp-10-1.png" width="672" /></p>
...
ggeffect(r_glm, &quot;sex&quot;) %&gt;% 
    ...
    brotools::theme_blog()</code></pre>
<img src="../assets/img/mice_exp-11-1.png" width="672" />
</details>
...
plot(feature_effect_original) +
    brotools::theme_blog()</code></pre>
<p><img src="../assets/img/mice_exp-19-1.png" width="672" /></p>
<pre class="r"><code>feature_effect_original &lt;- FeatureEffect$new(predictor_original, &quot;linc&quot;, method = &quot;pdp&quot;)
...
<p><img src="../assets/img/mice_exp-23-1.png" width="672" /></p>
...
<p><img src="../assets/img/mice_exp-26-1.png" width="672" /></p>
...
<p><img src="../assets/img/mice_exp-28-1.png" width="672" /></p>
...
<a href="2017-03-29-make-ggplot2-purrr.qmd">this other</a> blog post, which
...
effect_linc_results %&gt;% 
    ...
    brotools::theme_blog()</code></pre>
<p><img src="../assets/img/mice_exp-43-1.png" width="672" /></p>
