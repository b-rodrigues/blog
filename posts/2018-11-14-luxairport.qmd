...
<img src="../assets/img/lx_aie.jpg" title = "Luxembourg's largest aircraft landing"></a></p>
</div>
...
If you click here:</p>
<p><img src="../assets/img/eurostat_click_here.png" /><!-- --></p>
...
<pre class="r"><code>avia_clean_monthly %&gt;%
    ...
    theme_blog()</code></pre>
<p><img src="../assets/img/luxairport-16-1.png" width="672" /></p>
...
<pre class="r"><code>avia_clean_monthly %&gt;%
    ...
    scale_x_date(date_breaks = &quot;1 year&quot;, date_labels = &quot;%m-%Y&quot;) + 
    theme_blog()</code></pre>
<p><img src="../assets/img/luxairport-17-1.png" width="672" /></p>
...
<pre class="r"><code>avia_clean_monthly %&gt;%
    ...
    theme_blog()</code></pre>
<p><img src="../assets/img/luxaiport-24-1.png" width="672" /></p>
