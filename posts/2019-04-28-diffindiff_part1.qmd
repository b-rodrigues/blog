...
<p><img src="../assets/img/package_01.png" / width="80%" height="auto"><!-- --></p>
<p>Select “New Directory”:</p>
<p><img src="../assets/img/package_02.png" / width="80%" height="auto"><!-- --></p>
<p>Then “R package”:</p>
<p><img src="../assets/img/package_03.png" / width="80%" height="auto"><!-- --></p>
<p>and on the window that appears, you can choose the name of the package, as well as already some
starting source files:</p>
<p><img src="../assets/img/package_04.png" / width="80%" height="auto"><!-- --></p>
