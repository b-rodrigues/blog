...
<img src="../assets/img/cringe_speedrun.png" title = "Doom's first level in 8 seconds"></a></p>
</div>
<p><em>If you haven’t, you should read <a href="2021-09-04-quest_fast.qmd">this</a> first. This is part two.</em></p>
...
<a href="2021-09-04-quest_fast.qmd">previous blog post</a>
...
<a href="2021-09-04-quest_fast.qmd">previous blog post</a>):</p>
...
<pre class="r"><code>benchmark_data %&gt;%
  ...
  theme_blog()</code></pre>
<p><img src="../assets/img/speedrunning_rows-13-1.png" width="672" /></p>
