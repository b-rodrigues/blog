...
<img width = "400" src="../assets/img/tap-walker.gif" title = "Nietzsche's Übermensch"></a></p>
</div>
...
<pre class="r"><code>avia_clean_monthly %&gt;%
    ...
    theme_blog()</code></pre>
<p><img src="../assets/img/rgenoud_arima-14-1.png" width="672" /></p>
...
<pre class="r"><code>avia_clean_monthly %&gt;%
    ...
    geom_line(data = starting_model_forecast, aes(x = date, y = point_estimate), 
              linetype = 2, colour = &quot;#a53031&quot;) +
    theme_blog()</code></pre>
<p><img src="../assets/img/rgenoud_arima-21-1.png" width="672" /></p>
...
<pre class="r"><code>avia_clean_monthly %&gt;%
    ...
    geom_line(data = starting_model_forecast, aes(x = date, y = point_estimate), 
              linetype = 2, colour = &quot;#a53031&quot;) +
    theme_blog()</code></pre>
<p><img src="../assets/img/rgenoud_arima-28-1.png" width="672" /></p>
