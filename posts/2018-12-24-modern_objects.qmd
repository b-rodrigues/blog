...
<img width = "400" src="../assets/img/santa_sanders.jpg" title = "The frydiest time of the year" width="80%" height="auto"></a></p>
</div>
...
<div style="text-align: center;"><img src="../assets/img/rstudio_environment_list.gif"  width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/rstudio_view_data.gif"  width="80%" height="auto"></div>
<p>You can also use the <code>str()</code> function:</p>
<pre class="r"><code>str(my_data)</code></pre>
<p>And if you need to access an individual column, you can use the `$` sign, same as for a list:</p>
