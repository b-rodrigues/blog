...
menu:
  main:
    parent: Blog
    identifier: /blog/modern_objects
    weight: 1
---
...
<img width = "400" src="../assets/img/santa_sanders.jpg" title = "The frydiest time of the year"></a></p>
</div>
...
<p><img src="../assets/img/rstudio_environment_list.gif" /><!-- --></p>
...
<p><img src="../assets/img/rstudio_view_data.gif" /><!-- --></p>
