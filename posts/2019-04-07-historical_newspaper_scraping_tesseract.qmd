...
<img src="../assets/img/clio.jpg" title = "Historical newspapers as a source to practice cliometrics?" width="80%" height="auto"></a></p>
</div>
...
<div style="text-align: center;"><img src="../assets/img/market_price_table.png"  width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/table_and_edit.jpg"  width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-9-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-10-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/price_smoked_pig.png"  width="80%" height="auto"></div>
...
<pre class="r"><code>market_price %&gt;% 
    ...
    theme_blog()</code></pre>
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-13-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-14-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<pre class="r"><code>market_price %&gt;%
    ...
    theme_blog() + 
    labs(title = &quot;Prices of barley at the Luxembourg-City market in the 1870s&quot;)</code></pre>
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-15-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre class="r"><code>market_price %&gt;% 
    filter(good_en == &quot;Barley&quot;) %&gt;% 
    ggplot() + 
    geom_density(aes(price), colour = &quot;#82518c&quot;) + 
...
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-16-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-17-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
<pre class="r"><code>market_price %&gt;% 
    filter(good_en == &quot;Lentils&quot;) %&gt;% 
    ggplot() + 
    geom_density(aes(price), colour = &quot;#82518c&quot;) + 
...
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-18-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
...
<pre class="r"><code>market_price %&gt;%
    ...
    theme_blog() + 
    labs(title = &quot;Prices of lentils at the Luxembourg-City market in the 1870s&quot;)</code></pre>
<div style="text-align: center;"><img src="../assets/img/historical_newspaper_scraping_tesseract-19-1.png" width="80%" height="auto" / width="80%" height="auto"></div>
