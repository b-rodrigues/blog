...
<img src="../assets/img/clio.jpg" title = "Historical newspapers as a source to practice cliometrics?"></a></p>
</div>
...
<p><img src="../assets/img/market_price_table.png" /><!-- --></p>
...
<p><img src="../assets/img/table_and_edit.jpg" /><!-- --></p>
...
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-9-1.png" width="672" /></p>
...
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-10-1.png" width="672" /></p>
...
<p><img src="../assets/img/price_smoked_pig.png" /><!-- --></p>
...
<pre class="r"><code>market_price %&gt;% 
    ...
    theme_blog()</code></pre>
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-13-1.png" width="672" /></p>
...
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-14-1.png" width="672" /></p>
...
<pre class="r"><code>market_price %&gt;%
    ...
    theme_blog() + 
    labs(title = &quot;Prices of barley at the Luxembourg-City market in the 1870s&quot;)</code></pre>
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-15-1.png" width="672" /></p>
<pre class="r"><code>market_price %&gt;% 
    filter(good_en == &quot;Barley&quot;) %&gt;% 
    ggplot() + 
    geom_density(aes(price), colour = &quot;#82518c&quot;) + 
...
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-16-1.png" width="672" /></p>
...
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-17-1.png" width="672" /></p>
<pre class="r"><code>market_price %&gt;% 
    filter(good_en == &quot;Lentils&quot;) %&gt;% 
    ggplot() + 
    geom_density(aes(price), colour = &quot;#82518c&quot;) + 
...
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-18-1.png" width="672" /></p>
...
<pre class="r"><code>market_price %&gt;%
    ...
    theme_blog() + 
    labs(title = &quot;Prices of lentils at the Luxembourg-City market in the 1870s&quot;)</code></pre>
<p><img src="../assets/img/historical_newspaper_scraping_tesseract-19-1.png" width="672" /></p>
