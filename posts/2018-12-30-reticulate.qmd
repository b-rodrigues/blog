...
<img src="../assets/img/why not both.png" title = "This literally starts playing when you run both R and Python in the same session"></a></p>
</div>
...
<p><img src="../assets/img/autocompletion.png" /><!-- --></p>
<p>Fantastic!</p>
